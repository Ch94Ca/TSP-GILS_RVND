...
int main(int argc, char** argv)
{
        ...
        output_stream << endl << "dimension: " << dimension << endl;
        output_stream << endl << "i_max: " << i_max << " | i_ils: " << i_ils << endl;
        ...
        output_stream << endl << "---------------------------------------------------------------" << endl; output_stream << endl;
        ...
        output_stream << endl << "Total time: " << fixed << setprecision(9) << time_taken << " sec" << endl;
        ...
        output_stream << endl << "---------------------------------------------------------------" << endl;
        output_stream << endl << "Opt route: " << endl << endl;
        ...
        output_stream << endl << "cost: " << fixed << setprecision(0) << objective.cost;
...
solution gils_rvnd(int i_max, int i_ils)
{
        ...
        for(int i = 0; i < i_max; i++)
        {
                ...
                {
                        output_stream << endl << "Iter #" << setfill('0') << setw(2) << (i + 1) << " | 0 improvements | Time: " << time_taken << endl;
...
void printData()
{
        output_stream << endl << "dimension: " << dimension << endl << endl;
